package com.spark.mllib.mongodb;//package com.xtwy.pro_sp.mongodb;
//
...
//import com.xtwy.pro_sp.stat.model.FavorPredict;
//
///**
// * 用户收藏的产品的各个类别的购买率  1.6.2 api
// * @author Admin
// *
// */
//public class MongoRandomForestMainClassBuyStat {
//
...
//					FavorPredict favorPredict = new FavorPredict(favoriteCategoryId,insureCategoryId,prediction,pcount);
//					docs.add(Document.parse(JSONObject.toJSONString(favorPredict)));
//				}
//			}
//		});
//
//		Map<String, String> writeOverrides = new HashMap<String, String>();
//	       writeOverrides.put("collection", "favorPredict");
